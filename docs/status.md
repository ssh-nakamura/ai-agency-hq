...
| 項目 | 状態 |
|------|------|
| Website | LP HTML実装完了（未公開・ドメイン取得済み） |
| Xアカウント | 未開設 |
| YouTubeチャンネル | 未開設 |
| ドメイン | ai-unmanned.com（取得済み） |

### プロダクト
| 名前 | 状態 | 仕様書 |
|------|------|--------|
| ShieldMe | MVP仕様確定 | docs/specs/shieldme-mvp-spec.md |
| サイト自動生成 | 仕様確定・リポジトリ未作成 | docs/specs/site-generator-spec.md |
...
| ID | アクション | 担当 | 状態 | 備考 |
|----|-----------|------|------|------|
| A-025 | サイト公開（本番デプロイ） | site-builder | 未着手 | ドメイン取得済み → 着手可能 |
...
| ID | アクション | 担当 | 状態 | 備考 |
|----|-----------|------|------|------|
| A-030 | site-generatorリポジトリ作成 | 株主 | 未着手 | GitHub新規リポジトリ |
| A-031 | generate.py + テンプレートJSON 2種 実装 | CEO | 未着手 | A-030完了後。別リポジトリ内で実施 |
| A-032 | blog_gen.py 実装 | CEO | 未着手 | A-031完了後 |
| A-033 | hearing_sheet.html 作成 | CEO | 未着手 | A-031完了後 |
...
| ID | アクション | 担当 | 完了日 | 成果物 |
|----|-----------|------|--------|--------|
| A-024 | ドメイン取得（ai-unmanned.com） | CEO + 株主 | 2026-02-26 | ai-unmanned.com |
...
| ドメイン (ai-unmanned.com) | 未確認 | Cloudflareで取得済み。年額確認後に記録 |
